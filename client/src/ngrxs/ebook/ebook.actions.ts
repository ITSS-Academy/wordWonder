...
export const listAllSuccess = createAction(
  '[Ebook] List All Success',
  props<{ ebooks: EBookModel[] }>(),
);
export const listAllFailure = createAction(
  '[Ebook] List All Failure',
  props<{ error: any }>(),
);

export const listTrending = createAction(
  '[Ebook] List Trending',
  props<{ limit: number }>(),
);
export const listTrendingSuccess = createAction(
  '[Ebook] List Trending Success',
  props<{ ebooks: EBookModel[] }>(),
);
export const listTrendingFailure = createAction(
  '[Ebook] List Trending Failure',
  props<{ error: any }>(),
);

export const listRecommended = createAction(
  '[Ebook] List Recommended',
  props<{ limit: number }>(),
);
export const listRecommendedSuccess = createAction(
  '[Ebook] List Recommended Success',
  props<{
    ebooks: EBookModel[];
  }>(),
);
export const listRecommendedFailure = createAction(
  '[Ebook] List Recommended Failure',
  props<{ error: any }>(),
);

export const listRating = createAction(
  '[Ebook] List Rating',
  props<{ limit: number }>(),
);
export const listRatingSuccess = createAction(
  '[Ebook] List Rating Success',
  props<{ ebooks: EBookModel[] }>(),
);
export const listRatingFailure = createAction(
  '[Ebook] List Rating Failure',
  props<{ error: any }>(),
);
